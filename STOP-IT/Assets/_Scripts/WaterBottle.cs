...
public class WaterBottle : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Prompts built by the shared ProximityPrompt helper → fond + toujours-au-dessus.
        _pickupPrompt = ProximityPrompt.Build("WaterBottle_PickupPrompt", InputHints.ResolveVerbPrompt(pickupPromptText));
        _swapPrompt   = ProximityPrompt.Build("WaterBottle_SwapPrompt",   InputHints.ResolveVerbPrompt(swapPromptText));
    ...
    private void Update()
    {
        ...
        if (_pickupPrompt != null)
        {
            ...
            if (show) ProximityPrompt.Face(_pickupPrompt, transform.position + promptOffset, camPos);
        }
        ...
        if (_swapPrompt != null && targetHazardZone != null)
        {
            ...
            if (_held) ProximityPrompt.Face(_swapPrompt, targetHazardZone.transform.position + promptOffset, camPos);
        }
    }
